...
import com.teknokrat.mobile2019.if117fx15312393.pemasaranperumahan.ViewHolder.ProductViewHolder;
...
public class HomeActivity extends AppCompatActivity
        ...
        FirebaseRecyclerAdapter<Products, ProductViewHolder> adapter =
                new FirebaseRecyclerAdapter<Products, ProductViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull ProductViewHolder holder, int i, @NonNull final Products model) {
                        ...
                        holder.txtProductDescription.setText("Keterangan : " + model.getDescription());
                        holder.txtProductPrice.setText("Harga : Rp." + model.getPrice());
                        holder.txtLocation.setText("Lokasi : " + model.getLocation());
    ...
    public boolean onNavigationItemSelected( MenuItem item) {
        ...
        if (id == R.id.nav_categories){
            ...
            Intent intent = new Intent(HomeActivity.this, SettingProfilActivity.class);
            startActivity(intent);
